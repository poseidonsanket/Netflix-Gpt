  ...
  return (
    <div className="pt-[10%] flex justify-center">
      <div className="w-screen flex justify-center ">
        <form
          className="w-full m-1 md:w-1/2 grid grid-cols-12 bg-black"
        ...
        >
          ...
          />
          <button
            className="py-4 px-2 m-4 rounded-lg bg-red-700 text-white md:col-span-3 text-md col-span-4 md:text-2xl"
